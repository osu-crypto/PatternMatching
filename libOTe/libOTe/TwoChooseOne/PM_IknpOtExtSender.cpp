...
{
    using namespace std;
	std::unique_ptr<OtExtSender> PM_IknpOtExtSender::split()
    {

        std::unique_ptr<OtExtSender> ret(new PM_IknpOtExtSender());
    ...
    void PM_IknpOtExtSender::setBaseOts(span<block> baseRecvOts, const BitVector & choices)
    {
