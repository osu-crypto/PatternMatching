#include "PM_IknpOtExtReceiver.h"
...
namespace osuCrypto
{
    void PM_IknpOtExtReceiver::setBaseOts(span<std::array<block, 2>> baseOTs)
    {
    ...
    std::unique_ptr<OtExtReceiver> PM_IknpOtExtReceiver::split()
    {
        ...
        std::unique_ptr<OtExtReceiver> ret(new PM_IknpOtExtReceiver());
    ...
    void PM_IknpOtExtReceiver::receive(
